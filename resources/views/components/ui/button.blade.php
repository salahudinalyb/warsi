...
@php
    ...
    // Variant map
    $variantMap = [
        'primary' => 'bg-linear-to-b from-brand-400 to-brand-600 text-white shadow-theme-xs hover:from-brand-500 hover:to-brand-700 hover:shadow-lg hover:shadow-brand-500/25 active:scale-[0.97] disabled:from-brand-300 disabled:to-brand-300',
